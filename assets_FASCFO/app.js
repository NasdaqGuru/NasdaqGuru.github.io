(function () {
  ...
  const units = [
    {
      ...
      short: "Accounting",
      icon: "CC",
      href: "pages/controller-close.html",
      status: "At risk",
    ...
    },
    {
      ...
      short: "Budgeting",
      icon: "BP",
      href: "pages/budget-planning.html",
      status: "At risk",
    ...
    },
    {
      ...
      short: "Treasury",
      icon: "TL",
      href: "pages/treasury-liquidity.html",
      status: "On track",
      owner: "CFO + Treasury",
      due: "Jun 10, 2026",
    ...
    },
    {
      ...
      short: "ICR",
      icon: "SR",
      href: "pages/sponsored-research-icr.html",
      status: "At risk",
    ...
    },
    {
      ...
      short: "Gifts",
      icon: "GE",
      href: "pages/gift-endowment.html",
      status: "Human review",
    ...
    },
    {
      ...
      short: "Capital",
      icon: "CF",
      href: "pages/capital-facilities.html",
      status: "On track",
    ...
    },
    {
      ...
      short: "Revenue",
      icon: "RA",
      href: "pages/academic-revenue.html",
      status: "At risk",
    ...
    },
    {
      ...
      short: "Finance Admin",
      icon: "FO",
      href: "pages/finance-operations.html",
      status: "On track",
    ...
    },
    {
      ...
      short: "Intel/Gov",
      icon: "AG",
      href: "pages/audit-governance.html",
      status: "Human review",
  ...
  const basePath = rootPages.includes(pageSlug) ? "" : "../";
  ...
  function renderNav() {
    ...
    nav.innerHTML = `
      <a class="nav-link${intelligenceActive}" href="${basePath}index.html"><span class="nav-icon">IS</span><span>Intelligence Suite</span></a>
      <a class="nav-link${overviewActive}" href="${basePath}dashboard.html"><span class="nav-icon">EX</span><span>Executive Dashboard</span></a>
      <a class="nav-link${commandActive}" href="${basePath}command-center.html"><span class="nav-icon">CC</span><span>Command Center</span></a>
      ${unitLinks}
      <div class="nav-spacer"></div>
      <a class="nav-link${reportsActive}" href="${basePath}reports-library.html"><span class="nav-icon">DL</span><span>Reports Library</span></a>
      <a class="nav-link${referenceActive}" href="${basePath}pages/technical-reference.html"><span class="nav-icon">ST</span><span>Settings</span></a>
      <a class="nav-link" href="${basePath}README.md"><span class="nav-icon">?</span><span>Help</span></a>`;
  }
  ...
  function reportIntroVideoSrc() {
    return basePath + "assets/media/FAS_CFO_Command_Center.mp4?v=small";
  }
    ...
    root.innerHTML = `
      <section class="intel-hero">
        ...
        <div class="intel-hero-actions">
          ...
          <a class="ghost-button" href="dashboard.html">Compact Dashboard</a>
      ...
      <section class="intel-layout">
        ...
        <aside class="intel-rail">
          ...
          <article class="intel-rail-card archive-card">
            ...
            <a class="command-secondary full" href="legacy/FAS_CFO_Dashboard_Data_Pipeline_Monitor.html">Open archive file</a>
          </article>
      ...
      <section class="control-library" id="control-library">
        <details>
          ...
          <div class="control-library-toolbar"><a class="cc-text-button" href="pages/technical-reference.html">Open Data Dictionary</a></div>
  ...
  function openAllUnitsDetail() {
    ...
    openModal("Reporting units", "All CFO reporting-unit pages", body, `<a class="primary-button" href="${esc(basePath)}pages/technical-reference.html">Technical reference</a>`);
  }
